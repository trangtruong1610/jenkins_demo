pipeline{
    ...
    stages{
        ...
        stage('Functional regression tests') {
            steps {
                sh "docker run --shm-size=1g -e BROWSER=chrome -e ROBOT_TESTS_DIR=/opt/robotframework/tests -v $WORKSPACE/robot-tests:/opt/robotframework/tests:Z ppodgorsek/robot-framework"
            }
        }
